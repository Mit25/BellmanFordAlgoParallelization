...
int main(int argc, char **argv) {
    ...
    string in1="Input/"+filename;
    string out1="OutputSerial/"+filename;
	assert(utils::read_file(in1) == 0);
    ...
    std::cerr << "Time(s): " << ms_wall/1000.0 << endl<< "Clock Time: "<<cpu_time_used<<endl;

    utils::print_result(out1,has_negative_cycle, dist);
